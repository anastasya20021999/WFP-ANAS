...
<h1>Ubah Submaster {{$submaster->nama}}</h1>

<form method="POST" action="{{url ('submasters/'.$submaster->id)}}">
	{{method_field('PUT')}}
	
	<input type="hidden" name="_token" value="{{csrf_token()}}">
	<center><table>
		<tr>
			<td>Nama Submaster :</td>
			<td>
				<input type="text" name="nama_submaster" value="{{$submaster->nama}}">
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				<input type="text" name="jenis_pembayaran" value="{{$submaster->pembayaran}}">
			</td>
		</tr>
	</table>
